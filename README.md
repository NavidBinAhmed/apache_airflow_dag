...
**Grid** representation of DAG that spans across schdeduled/ manual time:
...
All three supports scheduling, dependancies, execution, and processes.
...
Step 3: Importing PythonOperator and defining tasks and flows
...
- Rebuilt after running

`docker-compose down --volumes --remove-orphans`

- and after changing the external:internal ports to 8081:8080
